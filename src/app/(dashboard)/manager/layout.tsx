...
export default function ManagerLayout({
    ...
    const allNavItems = [
        ...
        { label: 'ORDERS', path: '/manager/orders', icon: 'M6 2L3 6v14a2 2 0 002 2h14a2 2 0 002-2V6l-3-4H6z M3 6h18 M16 10a4 4 0 01-8 0', starterVisible: true },
